...
c     &        ivalue(n),value(n),name(n)
 ...
 99    continue      
       ...
       call set_it(n,ivalue,value,name,11,bn,elemass,0.511d-3)
       call set_it(n,ivalue,value,name,13,bn,mumass,0.106d0)
       ...
       call set_it(n,ivalue,value,name,611,bn,fmass,fmass*1d0)
       call set_it(n,ivalue,value,name,622,bn,apmass,1d0)
       call set_it(n,ivalue,value,name,623,bn,hpmass,100d0)
       bn="decay"
       ...
       call set_it(n,ivalue,value,name,611,bn,fwidth,0d0)
       call set_it(n,ivalue,value,name,622,bn,apwidth,1d-9)
