...
c
 ...
 25   format( 1x,a16,2x,f7.3,' GeV        ',a16,2x,f7.4,' GeV')
      ...
      write(6,*)  '---------------------'
      write(6,*)
      write(6,11) 'GAF(L)  =  ', GAF(1),'GAF(R)  =  ', GAF(2)
      write(6,11) 'GAN(L)  =  ', GAN(1),'GAN(R)  =  ', GAN(2)
      write(6,11) 'GEAPX(L)  =  ', GEAPX(1),'GEAPX(R)  =  ', GEAPX(2)
      write(6,11) 'GEAP(L)  =  ', GEAP(1),'GEAP(R)  =  ', GEAP(2)
      write(6,*)
      ...
      write(6,*) '-----------------------------'
      write(6,*)
      write(6,24) 'FMASS  =  ', FMASS, 'FWIDTH    = ', FWIDTH
      write(6,24) 'APMASS  =  ', APMASS, 'APWIDTH    = ', APWIDTH
      write(6,24) 'HPMASS  =  ', HPMASS, 'HPWIDTH    = ', HPWIDTH
      write(6,*)
